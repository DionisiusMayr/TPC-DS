...
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 88605
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 252270
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 276620
            then (select avg(ss_ext_sales_price)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 29817
            then (select avg(ss_ext_sales_price)
                  from store_sales
